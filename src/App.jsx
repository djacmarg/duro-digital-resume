        ...
        <Reveal>
          <div className="sect">
            ...
            <div className="wh">
              ...
              <ul>
                <li>
                  Maintaining School Management Systems that I built for
                  Clients.
                </li>
                <li>
            ...
            <div className="wh">
              ...
              <ul>
                ...
                <li>
                  Trained participants on records managements and database
                </li>
                <li>
        ...
        <Reveal>
          <div className="sect">
            ...
            <div className="np">
              ...
              <p className="pd">
                Fast, secure payments ZurePay’s gateway solutions make it fast
                and secure to accept payments from customers, no matter the
                size.
                <br />
                <br />
            ...
            <div className="np">
              <p className="pd">
                This application sends a realtime short message service (SMS)
                with the details such as students name, date and
                arrival/departure time to parents/guardian's phone immediately
                the student signed in with either their RFID card or
                fingerprints at the school premises.
              </p>
            </div>
            ...
            <div className="np">
              ...
              <p className="pd">
                This application is used by schools in Swaziland and Nigeria
                since 2019. This application consist of these 7 different
                modules [Admins, Teachers, Parents, Students, Library, Account &
                Transport]
              </p>
            </div>
            ...
            <div className="np">
              <h3>KiaHire</h3>
              <p className="pd">
                Esrow based freelance website that connects clients and
        ...
        <Reveal>
          <div className="sect">
            ...
            <p className="social">
              ...
              <a href={`${base_url}/certs/android.pdf`}>
